...
public class ModelsUpdateController {
    public static void updateUser(User user) throws SQLException {
        ...
        PreparedStatement statement = conn.prepareStatement("UPDATE users SET first_name=?, last_name=?, email=?, password=?, phone_number=? WHERE user_id = ?");
    ...
    public static void updateCategory(Category category) throws SQLException {
        Connection conn = Conn.get();
        PreparedStatement statement = conn.prepareStatement("UPDATE categories SET name=? WHERE category_id = ?");
    ...
    public static void updateProduct(Product product) throws SQLException {
        Connection conn = Conn.get();
        PreparedStatement statement = conn.prepareStatement("UPDATE products SET category_id=?, name=?, description=?, image_url=?, price=?, quantity=? WHERE product_id = ?");
